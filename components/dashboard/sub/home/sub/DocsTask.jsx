import { Play, Pause, BrainCog, UserRoundCog } from "lucide-react";
...
const PlayIcon = () => <Play width="22px" height="22px" color="white" />;
const PauseIcon = () => <Pause width="22px" height="22px" color="white" />;
const BrainCogIcon = () => (
  <BrainCog width="22px" height="22px" color="white" />
);
const UserRoundCogIcon = () => (
  <UserRoundCog width="22px" height="22px" color="white" />
);
      ...
      <div className="grid gap-8">
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
          <div className="grid gap-4">
            <h3 className="font-semibold">Set Up Social Media</h3>
            <div className="flex gap-4 items-center">
              <div className="bg-secondary/10 w-fit rounded-md px-3 py-6">
                <MessengerIcon />
              </div>
              <div>
          ...
          <div className="grid gap-4">
            <h3 className="font-semibold">Activate & Manage Workflows</h3>
            <div className="flex gap-4 items-center">
              <div className="bg-secondary/10 w-fit rounded-md px-3 py-6">
                <PlayIcon />
              </div>
          ...
          <div className="grid gap-4">
            <h3 className="font-semibold">Train AI & Assign Agents</h3>
            <div className="flex gap-4 items-center">
              <div className="bg-secondary/10 w-fit rounded-md px-3 py-6">
                <BrainCogIcon />
              </div>
