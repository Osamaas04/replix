...
export default function IntegrationFigure() {
  return (
    <div className="font-raleway text-secondary grid justify-items-center md:flex md:justify-around items-center">
      <ol className="items-start px-10 grid gap-8">
        <li>
          ...
          <p className="mt-1 text-secondary/70 text-sm max-w-96">
            Sync your social and messaging platforms to create a unified support
            system.
          </p>
        </li>
        <li>
          ...
          <p className="mt-1 text-secondary/70 text-sm max-w-96">
            Feed the AI with your data to make it smarter, faster, and tailored
            to your business.
          </p>
        </li>
        <li>
